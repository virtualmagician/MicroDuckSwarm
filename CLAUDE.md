...
3. **Protocol fidelity:** `docs/robotd-api.md` mirrors `duck-ipc-proto` in pollen-robotics/microduck (currently api v17). Never invent method names — re-verify upstream, update the doc, then implement. All robotd JSON fields are snake_case.
